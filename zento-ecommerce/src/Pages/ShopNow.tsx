        ...
        {show && (
          <section className="fixed top-20 right-4 z-50">
            <div className="bg-white flex flex-col h-full p-10 w-[450px] shadow-lg">
              ...
              {cart.map((item) => (
                <div key={item.id} className="flex gap-2 mb-6 items-center">
                  <img
                    width="120"
                    height="100"
                    src={item.image}
              ...
              <div className="mt-auto">
                <div className="py-6 bg-white flex justify-between items-center">
                  <span className="text-[#191919] text-base font-normal">
                    {cart.length} Product
                  </span>
                ...
                <button className="w-full px-10 py-4 bg-[#00b206] rounded-[43px] text-white text-base font-semibold">
                  Checkout
                </button>
              </div>
            </div>
            ...
            <div className="max-w-md w-full">
              <div className="bg-white rounded-2xl shadow-2xl overflow-hidden hover:shadow-3xl">
                <div className="relative">
                  <div className="absolute inset-0 bg-linear-to-br from-purple-400 to-indigo-600 opacity-75"></div>
                  <img
                    src={product?.image}
                    alt="Product Image"
